...
class PortfoliosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create portfolio" do
    assert_difference('Portfolio.count') do
      post portfolios_url, params: { portfolio: { description: @portfolio.description, photo1: @portfolio.photo1, photo2: @portfolio.photo2, photo3: @portfolio.photo3 } }
    end
  ...
  test "should update portfolio" do
    patch portfolio_url(@portfolio), params: { portfolio: { description: @portfolio.description, photo1: @portfolio.photo1, photo2: @portfolio.photo2, photo3: @portfolio.photo3 } }
